...
class Messages(metaclass=QSingleton):
    ...
    def __init__(self, main_window:MainWindow, message_windows:dict[int, MessageWindow]) -> None:
        ...
        self.incorrect_data_type = MessageWindow(
            main_window, message_windows, False, QMessageBox.Icon.Warning, APP_NAME, APP_ICON
        )
        self.account_already_exists = MessageWindow(
            main_window, message_windows, False, QMessageBox.Icon.Warning, APP_NAME, APP_ICON
        )
        self.zero_current_balance = MessageWindow(
            main_window, message_windows, True, QMessageBox.Icon.Question, APP_NAME, APP_ICON
        )
        ...
        self.day_out_range = MessageWindow(
            main_window, message_windows, False, QMessageBox.Icon.Critical, APP_NAME, APP_ICON
        )
        ...
        self.delete_account_warning = MessageWindow(
            main_window, message_windows, True, QMessageBox.Icon.Critical, APP_NAME, APP_ICON
        )

        self.empty_expression = MessageWindow(
            main_window, message_windows, False, QMessageBox.Icon.Information, APP_NAME, APP_ICON
        )
        ...
        self.delete_backup_confirmation = MessageWindow(
            main_window, message_windows, True, QMessageBox.Icon.Warning, APP_NAME, APP_ICON
        )
        ...
        self.update_available = MessageWindow(
            main_window, message_windows, True, APP_UPGRADE_ICON, APP_NAME, APP_ICON
        )

        self.no_internet = MessageWindow(
            main_window, message_windows, False, NO_INTERNET_ICON, APP_NAME, APP_ICON
        )
