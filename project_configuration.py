...
DEVELOPMENT_GUI_LIBRARY_DIRECTORY = os.path.join(ROOT_DIRECTORY, "dist", "main", "_internal", GUI_LIBRARY)
...
DEVELOPMENT_BACKUPS_DIRECTORY = os.path.join(ROOT_DIRECTORY, "dist", "main", BACKUPS_DIRECTORY_NAME)
