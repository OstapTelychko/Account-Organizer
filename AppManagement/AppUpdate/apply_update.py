...
BACKUPS_DIRECTORY_NAME, UPDATE_APP_DIRECTORY, UPDATE_BACKUPS_DIRECTORY, MAIN_EXECUTABLE
...
def apply_update() -> None:
    ...
    if DEVELOPMENT_MODE:#if app in development
        ...
        shutil.move(os.path.join(ROOT_DIRECTORY, "dist", "main", "_internal"),
